...
def to_excel(userinfo):
    ...
    # json.loads(userinfo)
    today_time = datetime.datetime.now().strftime("%Y_%m_%d")
    ...
    wb.save(r"D:\Work\spider_data\douyin_spider_data" + "\\" +today_time + " douyin用户信息spider1.xlsx")
    print("done")
...
if __name__ == '__main__':
    ...
    print(userInfo["videos"][0]["statistics"])
    print(userInfo["videos"][1]["statistics"])
    # to_excel(userInfo)
