...
def videos_to_excel(userinfo):
    ...
    wb = openpyxl.load_workbook(r"D:\Work\spider_data\douyin_spider_data\douyin 视频信息spider.xlsx")    #(r"D:\Work\spider_data\douyin_spider_data" + "\\" +"douyin_spider" + ".xlsx")
    ws = wb.active
    # ws.title = "videos_info"
    # ws.append(sheet_columns)
    for i in range(len(userinfo["videos"])):
...
if __name__ == '__main__':
    ...
    # userInfo10 = getUserAll("https://v.douyin.com/eXFvtAM/")  #爷爷等一下
    ...
    # videos_to_db(userInfo8)
    # videos_to_db(userInfo9)
    # videos_to_db(userInfo10)
    # videos_to_db(userInfo11)
    # videos_to_db(userInfo12)
    # videos_to_db(userInfo13)
    # videos_to_db(userInfo14)
    # videos_to_db(userInfo15)
    # videos_to_db(userInfo16)
